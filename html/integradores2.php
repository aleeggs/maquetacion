...
if (!$conexion->connect_error) {
    $sql = "SELECT nombre, integrantes, descripcion, archivo FROM proyectos WHERE semestre = 2";
...
<head>
    ...
    <title>Expo-ISIC 2024 - Integradores 2º</title>
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li><a class="active" href="integradores2.php">Integradores 2º</a></li>
    ...
    <main>
        <section>
            <h2>Proyectos Integradores de 2º Semestre</h2>
            <p>Esta sección muestra los proyectos registrados del segundo semestre.</p>
        </section>
